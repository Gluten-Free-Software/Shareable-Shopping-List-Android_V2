...
public class SharedListAdapter extends RecyclerView.Adapter<SharedListAdapter.ViewHolder> {
    ...
    private List<SharedListObj> values;
    ...
    public void add(int position, SharedListObj item) {
    ...
    public SharedListAdapter(String username, List<SharedListObj> myDataset) {
    ...
    @Override
    public SharedListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final SharedListObj SharedList = values.get(position);
        //System.out.println("This is the roomID in roomAdapter: " + room.getRoomID() + " ************************************************************");
        holder.txtHeader.setText(SharedList.getListName());
        holder.txtHeader.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("username", SharedList.getUsername());
                intent.putExtra("list", holder.txtHeader.getText().toString());
                intent.putExtra("listID", SharedList.getListID());
                context.startActivity(intent);

            }
        });

        holder.txtFooter.setText("Owner: " + SharedList.getUsername());
    }
